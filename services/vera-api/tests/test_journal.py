"""Journal document mechanics — the minimal structure the legacy-fallback parser owns:
`## ` entry boundaries, the lenient `Next check:` line, origin classification,
section-scoped writes, and archive month naming. Run under pytest."""
import time
