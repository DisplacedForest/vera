"""Editor Agent — date-aware staleness check, cross-domain links, and the Analyst-driven topic
mapping. Graph-reading helpers run against a temp Profile Graph; all LLM I/O is injected.
Run under pytest."""
import asyncio
import os
...
def test_future_dated_only_flags_after_today():
    ...
    assert editor.future_dated("2026-06-12: as of today", today) is False
