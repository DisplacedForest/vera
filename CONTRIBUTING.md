...
13. **Public Git artifacts contain no Linear identifiers.** Keep branch names, commit messages, pull-request text, source, documentation, release notes, and tags free of private tracker keys.
