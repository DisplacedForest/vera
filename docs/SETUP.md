...
Due journal watches resolve on a daily deterministic pass (`journal_resolve`, default 4:15): a watch whose resolve condition has been observed met and whose next-check date has passed flips to resolved, with no LLM involved.
