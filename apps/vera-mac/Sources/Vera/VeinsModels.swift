...
struct VeinEntry: Identifiable, Hashable, Sendable {
    ...
    static func mock() -> [VeinEntry] {
        [
            VeinEntry(kind: "status", label: "System", icon: "gearshape",
                      ...
                      providers: [],
                      options: [VeinOptionGroup(group: "Monitored sources", fields: [
                          VeinField(id: "src_containers", label: "Containers", type: "bool",
                                    choices: [], hint: "", value: "true", isOn: true),
                          VeinField(id: "src_home_assistant", label: "Home Assistant + HACS", type: "bool",
                                    choices: [], hint: "", value: "true", isOn: true),
                          VeinField(id: "src_network", label: "Network gear", type: "bool",
                                    choices: [], hint: "", value: "false", isOn: false),
                      ])],
                      jobs: [VeinJob(id: "updates", label: "Stack updates check",
                                     cron: "30 7 * * *", enabled: true, gated: nil)]),
            VeinEntry(kind: "weather", label: "Weather", icon: "cloud.sun",
                      blurb: "severe-weather pre-warnings for the home's coordinates",
                      nominalLabel: "clear", enabled: true, canEnable: true,
                      requires: [VeinRequirement(label: "home coordinates", met: true,
                                                 detail: "", integration: nil)],
                      providers: [VeinProvider(id: "forecast_url", label: "Forecast endpoint",
                      ...
                      options: [VeinOptionGroup(group: "Units & thresholds", fields: [
                          VeinField(id: "unit", label: "Temperature unit", type: "choice",
                                    choices: ["fahrenheit", "celsius"], hint: "",
                                    value: "fahrenheit", isOn: false),
                          VeinField(id: "gust_threshold", label: "Wind gust alert (mph)", type: "number",
            ...
            VeinEntry(kind: "signals", label: "Signals", icon: "antenna.radiowaves.left.and.right",
                      ...
                      options: [VeinOptionGroup(group: "Source groups", fields: [
                          VeinField(id: "grp_financial", label: "Financial stress", type: "bool",
                                    choices: [], hint: "Treasury yields, VIX, credit spreads",
                                    value: "true", isOn: true),
                          VeinField(id: "grp_geophysical", label: "Geophysical", type: "bool",
                                    choices: [], hint: "earthquakes, disaster alerts",
                                    value: "true", isOn: true),
                          VeinField(id: "grp_news", label: "News judge", type: "bool",
                                    choices: [], hint: "", value: "true", isOn: true),
                      ])],
                      jobs: [VeinJob(id: "signals", label: "Signals check",
                                     cron: "0 6,18 * * *", enabled: false,
                                     gated: "the Signals vein is off. Enable it in Veins.")]),
            VeinEntry(kind: "media", label: "Media", icon: "film",
                      blurb: "a weekly worth-adding digest for your media library",
                      nominalLabel: "quiet", enabled: false, canEnable: false,
                      requires: [VeinRequirement(label: "Overseerr", met: false,
                                                 detail: "connect Overseerr in Plugins",
                                                 integration: "overseerr")],
                      providers: [], options: [],
                      jobs: [VeinJob(id: "media_curate", label: "Media curation digest",
                                     cron: "0 9 * * 0", enabled: false,
                                     gated: "the Media vein is off. Enable it in Veins.")]),
        ]
    }
}
