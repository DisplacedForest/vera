...
13. **Public Git artifacts contain no private tracker identifiers.** Keep branch names, commit messages, pull-request text, source, documentation, release notes, and tags free of internal ticket keys and tracker names.
